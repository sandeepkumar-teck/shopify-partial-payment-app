...
export type CartOperation =
   ...
   * of components.
   */
  { lineExpand: ExpandOperation; lineUpdate?: never; linesMerge?: never; }
  |  /**
   ...
   */
  { lineExpand?: never; lineUpdate: UpdateOperation; linesMerge?: never; }
  |  /**
   ...
   * of components.
   */
  { lineExpand?: never; lineUpdate?: never; linesMerge: MergeOperation; };
...
export type Input = { cart: { lines: Array<{ id: string, quantity: number, depositNow: { value: string | null } | null, payNow: { value: string | null } | null, payNowVisible: { value: string | null } | null, remainingCod: { value: string | null } | null, fullPriceVisible: { value: string | null } | null, statusVisible: { value: string | null } | null, surchargeLine: { value: string | null } | null, codExtra: { value: string | null } | null, cost: { amountPerQuantity: { amount: string } }, merchandise:
        | { __typename: 'CustomProduct' }
        | { __typename: 'ProductVariant', id: string, title: string | null, product: { title: string } }
       }> } };
